...
// Renderizador principal: dibuja y actualiza todo el ecosistemapublic class OceanRenderer implements GLEventListener {
...
private void poblarMundo() {
    ...
    float[][] datosMed = {
    {-3f,0.8f,2f,0.42f},{4f,1.2f,-3f,0.38f},{-6f,1.0f,-5f,0.50f},
    {7f,1.4f,4f,0.35f}, {2f,1.6f,6f,0.44f}, {-5f,0.7f,7f,0.40f},
    };
    float[][] colMed = {
